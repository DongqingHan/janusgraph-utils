...
import com.wegraph.graphson.decompress.IdentityReducer;
import com.wegraph.tools.decompress.IdentityMapper;
 ...
 * 
 */
public class DataDecompress extends Configured implements Tool {
    @Override
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(conf, new DataDecompress(), args);
        System.exit(res);
    }
